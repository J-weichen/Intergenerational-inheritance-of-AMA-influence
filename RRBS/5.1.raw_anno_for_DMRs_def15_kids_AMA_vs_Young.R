...
#  6.59       9.34      50.55      33.52
#hypo
#promoter       exon     intron intergenic 
#  9.67       6.69      47.21      36.43 
#all
#promoter       exon     intron intergenic 
# 8.43       7.76      48.56      35.25
...
annotation_DMR_hyper<-as.data.frame(peakAnnoList$DMRs_hyper)
range(annotation_DMR_hyper$distanceToTSS)# -106916  875111
...
#注释数据与位点甲基化水平合并
myDiff_data<- read.csv("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_meth_PVALUE.csv", header=T,sep=",",check.names = F)
head(myDiff_data)
