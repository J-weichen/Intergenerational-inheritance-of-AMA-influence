...
head(kids_200bin_data)
data_region_raw<-kids_200bin_data[,1:22]
...
methy_CpG_region_plot_long2$analysis_name<-factor(methy_CpG_region_plot_long2$analysis_name,levels=c(paste0("YOUNG_K_",1:10),paste0("AMA_K_",1:10)))
head(methy_CpG_region_plot_long2)
...
ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample.pdf",global_meth_plot1,width=10, height=6)
ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample.png",global_meth_plot1,width=10, height=6)

ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample2.pdf",global_meth_plot2,width=10, height=6)
ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample2.png",global_meth_plot2,width=10, height=6)
...
compare_means(mean_all_bin~Age_group, data=methy_CpG_region_plot_long2,method = "wilcox.test",group_by="Age_group")
#.y.          group1 group2     p p.adj p.format p.signif method  
#mean_all_bin Young  AMA    0.283  0.28 0.28     ns       Wilcoxon
...
global_meth_plot6
#  Add p-value
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_mean_all_site.pdf")
...
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_mean_value_distribution.pdf")
...
#绘制目标基因的目标区域甲基化水平柱状图
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd1.pdf")
...
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd2.pdf")
...
dev.off()
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd3.pdf")
global_meth_plot9+stat_compare_means(method = "wilcox.test",aes(label=paste0(..method..,": "," p  ",..p.format..,"\n",..p.signif..)), label.x = 1.5, label.y = 40)
dev.off()
global_meth_plot_sd<-global_meth_plot9+stat_compare_means(method = "wilcox.test",aes(label=paste0(..method..,": "," p  ",..p.format..,"\n",..p.signif..)), label.x = 1.5, label.y = 40)
ggsave(file="/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd3.png",global_meth_plot_sd,width = 6, height =6)
ggsave(file="/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd3_2.png",global_meth_plot9,width = 6, height =6)

##calculation of DNA methylation level of DMRs
#for kids 
kids_200bin_data<-read.csv("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/kids_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_meth_PVALUE.csv",row.names = 1,check.names = F)
kids_200bin_data$bin_region <- unlist(lapply(strsplit(as.character(rownames(kids_200bin_data)), "[.]"), function(x) paste(x[1],x[2],x[3],sep="_")))
rownames(kids_200bin_data)<-kids_200bin_data$bin_region
head(kids_200bin_data)
dim(kids_200bin_data)
...
length(DMRs_hyper_region);length(DMRs_hypo_region)#186 #237

##plot DNA methylation in DMRs
pdf("/mnt/data/chenwei/huahua/4.methy_result/1.DMR_called/Kids_meth_levels_in_6X_DMRs_myDiff15q005_multiple_plot.pdf")

#个体分开绘制与保留所有点
data_raw_bin<-kids_200bin_data[,1:20]
...
#   .y.  group1 group2        p   p.adj p.format p.signif method  
#1 mean  YOUNG  AMA    2.69e-91 2.7e-91 <2e-16   ****     Wilcoxon
...
#计算单一样本平均甲基化水平
my_comparisons <- list(c("YOUNG","AMA"))
data_raw_bin3<-kids_200bin_data[,1:20]
...
P_mean_site_hyper6 <- ggboxplot(DMRs_hyper_data3, x = "Age_group", y = "mean",color = "Age_group", palette = ppCor[1:2],add = "jitter")+
...
P_mean_site_hypo6 <- ggboxplot(DMRs_hypo_data3, x = "Age_group", y = "mean",color = "Age_group", palette = ppCor[1:2],add = "jitter")+
  labs(x = "sample_group", y = "DNA_methylation", title = "DNA_methylation_in hypo_df15q005_DMRs")+
