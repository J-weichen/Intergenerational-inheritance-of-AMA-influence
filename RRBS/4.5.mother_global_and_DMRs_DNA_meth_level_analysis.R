...
#for mother
mother_200bin_data<-read.csv("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_meth_PVALUE.csv",row.names = 1,check.names = F)
head(mother_200bin_data)
data_region_raw<-mother_200bin_data[,1:22]
...
methy_CpG_region_plot_long2$analysis_name<-factor(methy_CpG_region_plot_long2$analysis_name,levels=c(paste0("YOUNG_M_",1:10),paste0("AMA_M_",1:10)))
head(methy_CpG_region_plot_long2)
dim(methy_CpG_region_plot_long2)#14234400       10
...
ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample.pdf",global_meth_plot1,width=10, height=6)
ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample.png",global_meth_plot1,width=10, height=6)

ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample2.pdf",global_meth_plot2,width=10, height=6)
ggsave("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample2.png",global_meth_plot2,width=10, height=6)
...
# mean_all_bin YOUNG  AMA    0.190  0.19 0.19     ns       Wilcoxon
...
global_meth_plot6
#  Add p-value
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_mean_all_site.pdf")
...
global_meth_plot8<-ggviolin(methy_CpG_region_plot_long, x="group", y="Num",fill="group",
  ...
  theme(plot.title = element_text(hjust=0.5,size=10,vjust=0.5),axis.text.x=element_text(hjust=0.5, vjust=0.5),axis.line = element_line(colour="black"))
#theme(plot.title = element_text(size=10,colour = "blue",face = "bold"),axis.title.x = element_text(size=10,colour = "black",face = "bold"),axis.title.y = element_text(size=10,colour = "black",face = "bold"),axis.text.x = element_text(size=10),axis.text.y = element_text(size=10,colour = "black"))
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_mean_value_distribution.pdf")
...
#绘制目标基因的目标区域甲基化水平柱状图
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd1.pdf")
...
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd2.pdf")
...
dev.off()
pdf("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd3.pdf")
global_meth_plot9+stat_compare_means(method = "wilcox.test",aes(label=paste0(..method..,": "," p  ",..p.format..,"\n",..p.signif..)), label.x = 1.5, label.y = 40)
dev.off()
global_meth_plot_sd<-global_meth_plot9+stat_compare_means(method = "wilcox.test",aes(label=paste0(..method..,": "," p  ",..p.format..,"\n",..p.signif..)), label.x = 1.5, label.y = 40)
ggsave(file="/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd3.png",global_meth_plot_sd,width = 6, height =6)
ggsave(file="/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/Boxplot_mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_sd3_2.png",global_meth_plot9,width = 6, height =6)

##calculation of DNA methylation level of DMRs
#for mother 
mother_200bin_data<-read.csv("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/mother_20_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_8sample_meth_PVALUE.csv",row.names = 1,check.names = F)
mother_200bin_data$bin_region <- unlist(lapply(strsplit(as.character(rownames(mother_200bin_data)), "[.]"), function(x) paste(x[1],x[2],x[3],sep="_")))
rownames(mother_200bin_data)<-mother_200bin_data$bin_region
head(mother_200bin_data)
dim(mother_200bin_data)
...
length(DMRs_hyper_region);length(DMRs_hypo_region)#250 #269

##plot DNA methylation in DMRs
pdf("/mnt/data/chenwei/huahua/4.methy_result/1.DMR_called/mother_meth_levels_in_6X_DMRs_myDiff15q005_multiple_plot.pdf")

#个体分开绘制与保留所有点
data_raw_bin<-mother_200bin_data[,1:20]
...
#计算单一样本平均甲基化水平
my_comparisons <- list(c("YOUNG","AMA"))
data_raw_bin3<-mother_200bin_data[,1:20]
