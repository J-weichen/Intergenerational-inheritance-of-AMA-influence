...
myDiff15q005_all<-father_DMR_all_big[,c("seqnames","start","end")]
myDiff15q005_hyper<-father_DMR_all_big[which(father_DMR_all_big$meth.diff> 0),c("seqnames","start","end")]
myDiff15q005_hypo<-father_DMR_all_big[which(father_DMR_all_big$meth.diff< 0),c("seqnames","start","end")]
...
#   31    25    18    28    12    20    17    13    25     8    23    37    14    14     9    31    21    22    24    28    18    26 

##hyper_DMR
##chr1 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19  chr2 chr20 chr21 chr22  chr3  chr4  chr5  chr6  chr7  chr8  chr9 
##8    17     7    15     5     7     9     4     8     2     8    22     3     7     3    17     6    14     7    12    11    14 
#hypo_DMR
#chr1 chr10 chr11 chr12 chr13 chr14 chr15 chr16 chr17 chr18 chr19  chr2 chr20 chr21 chr22  chr3  chr4  chr5  chr6  chr7  chr8  chr9 
#23     8    11    13     7    13     8     9    17     6    15    15    11     7     6    14    15     8    17    16     7    12 
