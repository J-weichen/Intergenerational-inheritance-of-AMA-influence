...
gene.obj=readTranscriptFeatures("/mnt/data/chenwei/reference_file/RefSeq_Genes.bed")
...
#    7.83       8.55      46.23      37.39 
#hypo
#promoter       exon     intron intergenic 
#   9.36       9.57      44.36      36.70 
#all
#promoter       exon     intron intergenic 
# 8.71       9.14      45.15      36.99 
...
cpg.obj=readFeatureFlank("/mnt/data/chenwei/reference_file/7-CpGislands.bed",feature.flank.name=c("CpGi","shores"))
...
#注释数据与位点甲基化水平合并
myDiff_data<- read.csv("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/varification_kids_10_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_4sample_meth_PVALUE.csv", header=T,sep=",",check.names = F)
head(myDiff_data)
...
data_region_merge$meth_df2<-(data_region_merge$AMA_Kids_mean -data_region_merge$YOUNG_Kids_mean)
data_region_merge$log10_FC<-log10(data_region_merge$AMA_Kids_mean/data_region_merge$YOUNG_Kids_mean)
...
head(data_region_merge_DMR_all,n=3);dim(data_region_merge_DMR_all)
...
#hyper
#promoter       exon     intron intergenic 
#   13.46       8.81      38.87      38.87 
#hypo
#promoter       exon     intron intergenic 
#   9.51       7.84      45.45      37.20 
#all
#promoter       exon     intron intergenic 
#  11.30       8.28      42.47      37.96 
...
#注释数据与位点甲基化水平合并
myDiff_data<- read.csv("/mnt/data/chenwei/huahua/4.methy_result/0.global_compasion/varification_mother_10_samples_meth_level_CpG_6X_meth_bismark_200bp_3L_4sample_meth_PVALUE.csv", header=T,sep=",",check.names = F)
head(myDiff_data)
myDiff_data$bin_region <- unlist(lapply(strsplit(as.character(myDiff_data$Row.names), "[.]"), function(x) paste(x[1],x[2],x[3],sep="_")))
rownames(myDiff_data)<-myDiff_data$bin_region
head(myDiff_data);dim(myDiff_data)
