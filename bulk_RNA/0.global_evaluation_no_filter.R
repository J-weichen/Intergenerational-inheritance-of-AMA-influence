...
write.table(count.table,file="/mnt/data/chenwei/huahua/3.mapped_data/valification/trans/4.count/file1_all_no_filter_Verification_AMA_versus_Young_rawcount.xls",sep="\t", quote=F, row.names=T,col.names=T)

#step one:read data
count.table2<-read.table(file="/mnt/data/chenwei/huahua/3.mapped_data/valification/trans/4.count/file1_all_no_filter_Verification_AMA_versus_Young_rawcount.xls",sep="\t", row.names=1,header =T)
head(count.table2)
...
write.table(count.table_XY_removed,file="/mnt/data/chenwei/huahua/3.mapped_data/valification/trans/4.count/file2_all_no_filter_Verification_AMA_versus_Young_rawcount_XY_removed.xls",sep="\t", quote=F, row.names=T,col.names=T)
...
head(colData_whole)
write.table(colData_whole,file="/mnt/data/chenwei/huahua/file3_all_no_filter_verification_AMA_analysis_metadata.csv",sep=",", quote=F, row.names=T,col.names=T)
...
ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_gene_detected_in_AMA_Young_RNA_library.pdf"),count_plot,width = 200, height =200, units = "mm")
#}
...
ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_trans_three_type_in_AMA_Young_RNA_library.pdf"),trans_plot,width = 620, height =200, units = "mm")
...
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_distance_count_not_normal_in_AMA_Young_RNA_library.pdf"),width = 10, height =10)
...
sampleDistMatrix <- as.matrix(sampleDists)
colors <- colorRampPalette( rev(brewer.pal(9, "Greens")) )(255)
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_distance_count_normal_in_AMA_Young_RNA_library.pdf"),width = 10, height =10)
...
sampleDistMatrix <- as.matrix(sampleDists)
colors <- colorRampPalette( rev(brewer.pal(9, "Greens")) )(255)
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_distance_count_rld_in_AMA_Young_RNA_library.pdf"),width = 10, height =10)
...
sampleDistMatrix <- as.matrix(sampleDists)
colors <- colorRampPalette( rev(brewer.pal(9, "Greens")) )(255)
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_distance_count_vsd_in_AMA_Young_RNA_library.pdf"),width = 10, height =10)
...
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_cluster_not_normal_in_AMA_Young_RNA_library.pdf"),width = 10, height =6)
...
lable_cor[which(hc$order %in% c(1:6,14:19))] <- ppCor[1]
labels_colors(row_dend) <- lable_cor
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_cluster_normal_in_AMA_Young_RNA_library.pdf"),width = 10, height =6)
...
lable_cor[which(hc$order %in% c(1:6,14:19))] <- ppCor[1]
labels_colors(row_dend) <- lable_cor
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_cluster_rld_in_AMA_Young_RNA_library.pdf"),width = 10, height =6)
...
lable_cor[which(hc$order %in% c(1:6,14:19))] <- ppCor[1]
labels_colors(row_dend) <- lable_cor
pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_cluster_vsd_in_AMA_Young_RNA_library.pdf"),width = 10, height =6)
...
ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_rld_PCA_in_AMA_Young_RNA_library.pdf"),plot_rld_PCA,width = 10, height =10)
...
#                 PC1    PC2    PC3    PC4     PC5
#R2                  0.5727 0.08024 0.06397 0.03974 0.0299
#Cumulative R2 0.5727 0.65291 0.71688 0.75662 0.7865
...
plot_rld_PCA2<-ggplot(data=rld_PCA, mapping=aes(x=PC1,y=PC2,colour =group_type,shape= group_type))+
  ...
  theme_bw()+theme(panel.border = element_rect(colour="grey",fill=NA),
                   ...
                   axis.title = element_text(size=15),axis.text.x = element_text(size=15), 
                   axis.text.y = element_text(size=15),legend.position = "right")
ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_rld_PCA_self_cal_in_AMA_Young_RNA_library.pdf"),plot_rld_PCA2,width = 10, height =10)
...
#Importance of component(s):
#                 PC1    PC2    PC3     PC4     PC5
#R2            0.6266 0.06085 0.04158 0.03653 0.0228
#Cumulative R2 0.6266 0.68745 0.72903 0.76556 0.7884
...
plot_not_normal_PCA<-ggplot(data=count_PCA, mapping=aes(x=PC1,y=PC2,colour = group_type,shape= group_type))+
  ...
  theme_bw()+theme(panel.border = element_rect(colour="grey",fill=NA),
                   ...
                   axis.title = element_text(size=15),axis.text.x = element_text(size=15), 
                   axis.text.y = element_text(size=15),legend.position = "right")
ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_not_normal_PCA_in_AMA_Young_RNA_library.pdf"),plot_not_normal_PCA,width = 10, height =10)
...
#Importance of component(s):
#                 PC1    PC2    PC3    PC4     PC5
#R2            0.4842 0.07665 0.05927 0.04026 0.03377
#Cumulative R2 0.4842 0.56080 0.62007 0.66033 0.69410
