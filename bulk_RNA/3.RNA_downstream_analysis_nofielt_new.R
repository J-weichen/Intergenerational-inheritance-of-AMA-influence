...
count.table_XY_removed<-read.table(file="/mnt/data/chenwei/huahua/3.mapped_data/valification/trans/4.count/file2_all_no_filter_Verification_AMA_versus_Young_rawcount_XY_removed.xls",sep="\t", row.names=1,header =T)
...
for (tag_name in type){
  ...
  write.table(AMA_deseq2_log2_normalized_count,file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/file4_all_no_filter_",tag_name,"_verification_AMA_deseq2_log2_normalized_count.txt"),sep="\t", quote=F, row.names=T,col.names=T)
  ...
  ggplot(df, aes(x = sample2, y = sample3)) + geom_hex(bins = 80) + coord_fixed() + facet_grid( . ~ transformation)
  ...
  write.table(normalized_counts,file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/file5_all_no_filter_",tag_name,"_verification_AMA_deseq2_normalized_count.txt"),sep="\t", quote=F, row.names=T,col.names=T)
  #log2
  ...
  write.table(normalized_counts_log2,file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/file6_all_no_filter_",tag_name,"_verification_AMA_deseq2_log2_normalized_count_order.txt"),sep="\t", quote=F, row.names=T,col.names=T)
  # other log transform
  rlog_dds3_Mat <- assay(rld)
  rlog_dds3_Mat <- rlog_dds3_Mat[order(normalized_counts_mad, decreasing=T), ]
  write.table(rlog_dds3_Mat,file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/file7_all_no_filter_",tag_name,"_verification_AMA_deseq2_rlg_count.txt"),sep="\t", quote=F, row.names=T,col.names=T)
  ...
  file <- paste0("/mnt/data/chenwei/huahua/5.valificat_result/file8_all_no_filter_",tag_name,"_verification_",sampleA,"_vs_",sampleB,".gene_information_unselect.txt")
  ...
  file <- paste0("/mnt/data/chenwei/huahua/5.valificat_result/file9_all_no_filter_",tag_name,"_verification_",sampleA,"_vs_",sampleB,".log2_normalized_count_add_gene_information.txt")
  write.table(merge_data, file=file, sep="\t", quote=F, row.names=F,col.names=T)
  
  table(merge_data$pvalue<0.05)#1493  
  table(merge_data$pvalue<0.01)#  383   
  table(merge_data$pvalue<0.05 & abs(merge_data$log2FoldChange)>=0.585)# 1102    
  table(merge_data$padj<0.1)#13 
  ...
  file <-  paste0("/mnt/data/chenwei/huahua/5.valificat_result/file10_all_no_filter_",tag_name,"_verification_",sampleA,"_vs_",sampleB,".DEG_information_padj005_FC1.5.txt")
  ...
  file <- paste0("/mnt/data/chenwei/huahua/5.valificat_result/file11_all_no_filter_",tag_name,"_verification_",sampleA,"_vs_",sampleB,".DEG_information_padj01_FC1.5.txt")
  write.table(as.data.frame(DEG_information), file=file, sep="\t", quote=F, row.names=T, col.names=T)
  ...
  res_de_dw <- subset(res_de, res_de$log2FoldChange<=(-1)*0.585)
  DEG_information<-rbind(res_de_up,res_de_dw)
  file <- paste0("/mnt/data/chenwei/huahua/5.valificat_result/file12_all_no_filter_",tag_name,"_verification_",sampleA,"_vs_",sampleB,".DEG_information_pvalue001_FC1.5.txt")
  write.table(as.data.frame(DEG_information), file=file, sep="\t", quote=F, row.names=T, col.names=T)
  ...
  res_de_dw <- subset(res_de, res_de$log2FoldChange<=(-1)*0.585)
  DEG_information<-rbind(res_de_up,res_de_dw)
  file <- paste0("/mnt/data/chenwei/huahua/5.valificat_result/file13_all_no_filter_",tag_name,"_verification_",sampleA,"_vs_",sampleB,".DEG_information_pvalue005_FC1.5.txt")
  write.table(as.data.frame(DEG_information), file=file, sep="\t", quote=F, row.names=T, col.names=T)
...
#绘制各组特异高表达基因热图
  ...
  pdf(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_heatmap_DEGs_p005_FC1.5_AMA_Young.pdf"),width = 7, height =7)
  print(heat_plot)
  dev.off()
...
for ( i in 1:length(list_name_used)){
    ...
    write.table(as.data.frame(CC@result), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_CC_GO.txt"), row.names=T, col.names=T) 
    write.table(as.data.frame(BP@result), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_BP_GO.txt"),row.names=T, col.names=T) 
    write.table(as.data.frame(MF@result), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_MF_GO.txt"),row.names=T, col.names=T) 
    write.table(as.data.frame(CC_simp@result), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_BP_GO_simp.txt"),row.names=T, col.names=T) 
    write.table(as.data.frame(MF_simp@result), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_MF_GO_simp.txt"), row.names=T, col.names=T) 
    head(as.data.frame(BP_simp))
    write.table((as.data.frame(rpea@result)), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_RPEA.txt"),row.names=T, col.names=T) 
    ...
    if(is.null(kk)){gene_GO_RPEA_erichment_results=list(CC,BP,MF,CC_simp,BP_simp,MF_simp,rpea)
      ...
      write.table((as.data.frame(kk@result)), file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_KEGG.txt"),row.names=T, col.names=T) 
      gene_GO_RPEA_erichment_results=list(CC,BP,MF,CC_simp,BP_simp,MF_simp,kk,rpea)
    }
    saveRDS(gene_GO_RPEA_erichment_results, file = paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_",as.character(list_name_used[[i]]),"_GO_RPEA_result.rds"))
  }
  
  #step eleven: plot target  enrichment_AMA_nobatch result
  # https://www.jianshu.com/p/e133ab3169fa 
  gene_erichment_results_Up<-readRDS(file = paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_up_pvalue005_FC1.5_GO_RPEA_result.rds"))
  gene_erichment_results_Down<-readRDS(file = paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_dw_pvalue005_FC1.5_GO_RPEA_result.rds"))
  ...
  pdf(paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_Up_BP_CC_MF.pdf"))
  ...
  pdf(paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_Down_BP_CC_MF.pdf"))
  ggbarplot(merge_three, x="Description", y="qvalue_log10", fill = "group", color = "white", 
            palette = "aaas", #杂志Science的配色 "npg"
            #          sort.val = "asc", #上升排序,区别于desc，具体看图演示 "desc", #下降排序
            sort.val = "desc", 
  ...
  PP_plot<-KEGG_plot
  head(PP_plot)
  pdf(paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_Up_Down_gene_KEGG.pdf"))
  ...
  write.table(Enrich_all_plot2, file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_GO_BP_merge.txt"),row.names=T, col.names=T) 
  
  Enrich_all_plot_noselect<-read.table(paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_GO_BP_merge.txt"),header =T) 
  ...
  write.table(Enrich_all_plot_noselect, file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_wait_selected_GO_BP_merge.txt"),row.names=T, col.names=T) 
  ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_wait_selected_GO_BP.pdf"),GO_BP_plot,width =15,height =45)
  ...
  colnames(Enrich_all_number)<-c("Description","freq")
  Enrich_all_plot2<-merge(Enrich_all_plot,Enrich_all_number)
  write.table(Enrich_all_plot2, file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_KEGG_merge.txt"),row.names=T, col.names=T) 
  
  Enrich_all_plot_noselect<-read.table(paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_KEGG_merge.txt"),header =T) 
  head(Enrich_all_plot_noselect)
  ...
  KEGG_plot<-ggplot(Enrich_all_plot_noselect,aes(x=group,y=Description,size=Count,colour=Log10_pvalue))+
    ...
    theme(legend.text = element_text(size = 10, colour = "black"),
          ...
          legend.title = element_text(size = 10),
          legend.position ="right",legend.direction = "vertical")
  write.table(Enrich_all_plot_noselect, file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_wait_selected_KEGG_merge.txt"),row.names=T, col.names=T) 
  ggsave(file=paste0("/mnt/data/chenwei/huahua/5.valificat_result/All_no_filter_",tag_name,"_enrichment_",sampleA,"_vs_",sampleB,"_wait_selected_KEGG.pdf"),KEGG_plot,width =15,height =20)
